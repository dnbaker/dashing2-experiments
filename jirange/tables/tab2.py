...
expected_columns = ['bin', 'k', 'totbits', 'n', 'BD1', 'BD2', 'BD4', 'Dash1', 'FSS1', 'SS1', 'BD8', 'FSS8', 'Mash', 'SS8']
use_sketches = ['32768', '65536', '131072', '262144', '524288']
use_tools = ['Mash', 'BD1', 'Dash1', 'SS1']
...
with open('20sedf_large_ji_sse_subset.fixed.tbl', 'rb') as fh:
    for ln in fh:
        ln = ln.rstrip()
