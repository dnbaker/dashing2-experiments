...
expected_columns = ['bin', 'k', 'totbits', 'n', '`BMH1-500000`', '`BMH1-50000000`', 'Dash1', 'FSS1', 'FSSN', 'JItrue', '`PMH1-500000`', '`PMH1-50000000`', 'SS1', 'WJItrue', 'FSS8', 'Mash', 'SS8']
use_sketches = ['32768', '65536', '131072', '262144', '524288']
use_tools = ['Mash', 'Dash1', 'SS1', '`PMH1-50000000`']
use_ks = ['21', '31']  # don't have 31 it seems

sketches_rename = {'32768': '32',
                   '65536': '64',
                   '131072': '128',
                   '262144': '256',
                   '524288': '512'}
...
last_k = ''
with open('20sedf_large_ani_sse.tbl', 'rb') as fh:
    for ln in fh:
        ln = ln.rstrip()
...
print('\\end{tabular}')
print('\\caption{Sum of squared error ANI}')
print('\\end{table}')
