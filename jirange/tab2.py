...
expected_columns = ['bin', 'k', 'totbits', 'n', 'BD1', 'BD2', 'BD4', 'BD8', 'Dash1', 'FSS1', 'FSS8', 'Mash', 'SS1', 'SS8']
use_sketches = ['32768', '65536', '131072', '262144', '524288']
use_tools = ['Mash', 'BD1', 'Dash1', 'SS1']
use_ks = ['21']  # don't have 31 it seems
...
last_k = ''
with open('20sedf_large_ji_sse_subset.tbl', 'rb') as fh:
    for ln in fh:
        ln = ln.rstrip()
