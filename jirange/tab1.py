...
expected_columns = ['bin', 'k', 'totbits', 'n', 'Dash1', 'FSS1', 'SS1', 'FSS8', 'Mash', 'SS8']
use_sketches = ['32768', '65536', '131072', '262144', '524288']
use_tools = ['Mash', 'SS8', 'Dash1', 'SS1']
use_ks = ['21', '31']
...
print(' & '.join(['k', 'kbits'] + use_tools) + ' \\\\ \\hline')
last_k = ''
with open('20sedf_large_ji_sse.tbl', 'rb') as fh:
    for ln in fh:
        ln = ln.rstrip()
